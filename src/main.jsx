...
import{ArrowUpRight,ChevronLeft,Menu,X,Trash2,LogOut,Upload}from'lucide-react';
import'./styles.css';
import{databaseConfigured,deleteFlash,fetchFlash,getSession,insertFlash,removeImage,signIn,signOut,uploadImage}from'./supabase';

const BOOK='https://tally.so/r/686Gdk';
const IG='https://www.instagram.com/lucidblvck.ttt/';
...
function Header(){
  ...
  const onFlash=location.pathname.startsWith('/flash');
...
function Footer({flash=false}){
  return(
    <footer>
      ...
      <img
        src="/images/lucid-blvck-mark-white.png"
        alt="Lucid Blvck"
      />

      <a href="#top">
        {flash?'All flash':'Back to top'} ↑
      </a>
    </footer>
  );
}
  ...
  return(
    <main id="top">
      ...
      <section id="about" className="about">
        ...
        <div className="about-grid">
          ...
          <div>
            ...
            <p>
              My style is inspired by darker imagery and organic shapes.
            </p>

            <p>
              I enjoy creating custom tattoos that complement the natural
              flow of the body. From smaller tattoos to larger projects,
              I like each design to feel intentional and personal to the
              person wearing it.
            </p>

            <p>
              I work from a private studio in Kasterlee, by appointment
              only. This allows me to offer a calm, relaxed and personal
              setting, with plenty of time and attention dedicated to your
              tattoo experience.
            </p>
          </div>
        </div>
      ...
      <section className="cta">
        ...
        <p>
          Complete the booking form to share your tattoo idea.
        </p>

        <small>
          Appointments on selected days · Kasterlee, Belgium
        </small>
      </section>
    ...
    return(
      <main className="admin">
        <section>
          ...
          <p className="notice">
            Add the two Supabase environment variables in Netlify to
            activate secure login and uploads.
          </p>
        </section>
      </main>
    );
    ...
    <main className="admin">
      <section>
        ...
        <div className="admin-list">
          ...
          {!remote.length&&(
            <p className="empty">
              No uploaded flash yet. The original designs remain
              available as static website content.
            </p>
          )}
        </div>
      </section>
